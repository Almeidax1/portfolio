  ...
  const experiences = [
    {
      ...
      company: "EMPRESA ERA",
      logo: "/logoeraempresa.jpeg?height=60&width=60",
      location: "Presencial",
    ...
    },
    {
      ...
      type: "Efetivado",
      description:
          "Atuo no suporte técnico realizando atendimento de tickets, auxiliando clientes e resolvendo problemas na plataforma. Tenho experiência na configuração de sistemas Omnichannel e PABX, além de atuar nas integrações e ajustes relacionados à Meta (WhatsApp, Facebook e Instagram). Meu foco é garantir o bom funcionamento das soluções com agilidade e qualidade no atendimento.",
      technologies: ["A definir"],
      achievements: ["A definir", "A definir"],
    },
  ]
